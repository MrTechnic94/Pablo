...
const { packageUpdater } = require('../services/updater');
...
async function startup() {
    ...
    checkEnvVariables(['BOT_TOKEN', 'BOT_ID', 'BOT_OWNER_ID', 'BIBLE_API_KEY', 'DB_HOST', 'DB_PORT'], logger);

    // Sprawdza czy tryb developera jest odpowiednio skonfigurowany
    if (global.isDev) checkEnvVariables(['DEV_BOT_TOKEN', 'DEV_BOT_ID', 'DEV_DB_HOST', 'DEV_DB_PORT'], logger);
