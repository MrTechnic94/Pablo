...
class PabloClient extends Client {
    constructor(logger) {
        ...
        this.utils = {
            get createEmbed() {
                return require('../utils/interfaceBuilder.js').createEmbed;
            },
            ...
            get getPlural() {
                return require('../utils/parseTime.js').getPlural;
            },
            ...
            get parseEmojiId() {
                return require('../utils/emojiParser').parseEmojiId;
            },

            get parseEmojiUrl() {
                return require('../utils/emojiParser').parseEmojiUrl;
            },
